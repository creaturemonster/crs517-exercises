...
import java.text.*;
/**
 *  This servlet allows the user to reset the prices of the recordings in the database.  
 *  @author 517 Development Team
 *
 */
public class ResetPricesServlet extends HttpServlet {
    ...
    public void doGet (HttpServletRequest request, HttpServletResponse response)
	  throws ServletException, IOException {
		...
		rainforestService.resetAllPrices();
	...
	protected void buildHtmlTable(List<Recording> theList, PrintWriter out, HttpServletResponse response) {
		...
		out.println("<h4>New Price of Recordings has been Reset</h4>");
