       ...
       -->
	     <form:form modelAttribute="enquiry">
    	   ...
    	   <table border="0" cellpadding="0">
            <tr>                                            <!--  TODO  Define a Spring form errors tag here with path="name"-->
              <td><label for="name">* Contact name</label> <form:errors path="name"  cssClass="validationErrors"/> </td>
            </tr> 
            <tr>  <!--  TODO Define a Spring form input tag here with a path attribute of "name" -->  
            ...
            <tr>
              <td><br><label for="favoriteMusicCategory">Favorite Music Category</label></td>
            </tr>
            <tr>
              <td><form:select path="favoriteMusicCategory" items="${musicCategories}"/></td>
            </tr>
            <tr>
              <td><br><label for="contactMe">Send me special offers</label></td>
            </tr>
            <tr>
              <td><form:checkbox path="contactMe"/></td>
            </tr>
            <tr>
